...
let favoriteBook = Book(title: "The Catcher in the Rye", author: "J.D. Salinger", pages: 224, price: 12.99)
...
let myLaptop = Laptop(screenSize: 15, repairCount: 2, yearPurchased: 2020)
let yourLaptop = Laptop(screenSize: 13, repairCount: 1, yearPurchased: 2022)
