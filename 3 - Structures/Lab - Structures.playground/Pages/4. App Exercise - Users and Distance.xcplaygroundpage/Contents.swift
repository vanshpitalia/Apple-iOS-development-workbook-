...
var aditya = User(name: "Aditya", age: 20, height: 180, weight: 62, activityLevel: 7)

print("\(aditya.name) is \(aditya.age) years old. He is \(aditya.height)cm tall and weighs \(aditya.weight)kg. His activity level is \(aditya.activityLevel).")
